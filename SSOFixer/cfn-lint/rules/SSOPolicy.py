...
Copied and adapted from https://github.com/aws-cloudformation/cfn-python-lint/blob/master/src/cfnlint/rules/resources/iam/Policy.py
"""
import json
...
class SSOPolicy(CloudFormationLintRule):
    """Check if IAM Policy JSON is correct"""
    id = 'E9001'
    shortdesc = 'Check if IAM Policy in SSO Permission Set is properly configured'
    ...
    def __init__(self):
        """Init"""
        super(SSOPolicy, self).__init__()
        self.resource_exceptions = {
        }
        self.resources_and_keys = {
        }
        self.idp_and_keys = {
            'AWS::SSO::PermissionSet': 'PolicyDocument',
        }
